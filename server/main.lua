...
ESX.RegisterServerCallback('esx_society:setJob2', function(source, cb, identifier, job2, grade, type)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_society:isBoss', function(source, cb, job, job2)
