...
AddEventHandler('esx_addonaccount:setMoney', function(society, money)
	if (ESX.PlayerData.job and ESX.PlayerData.job.grade_name == 'boss' and 'society_' .. ESX.PlayerData.job.name == society) or
		(ESX.PlayerData.job2 and ESX.PlayerData.job2.grade_name == 'boss' and 'society_' .. ESX.PlayerData.job2.name == society) then
		UpdateSocietyMoneyHUDElement(money)
	end
end)
